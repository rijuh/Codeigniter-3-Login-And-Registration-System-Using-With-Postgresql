...
<body oncopy="return true" oncut="return true" onpaste="return true ">
    ...
    <div class="container">
        <div class="login-container">
            ...
            <?php if($this->session->flashdata('notMatched')) {?>
                <div class="alert alert-danger" role="alert">
                    Password not matched
                </div>
            <?php } ?>

            <?php if($this->session->flashdata('notReset')) {?>
                <div class="alert alert-danger" role="alert">
                    Password not reset
                </div>
            <?php } ?>
            ...
            <form method="post" action="<?php echo base_url('check-user'); ?>">
                <div class="form-group">
                    <label for="loginId">Email*</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter your email id" value="<?php echo set_value('email'); ?>" name="email" autocomplete="off">
                    <em id="email-em"></em>
                    <?php echo form_error('email', '<div class="error">', '</div>'); ?>
                </div>
                <div class="form-group">
                    <label for="mobile">Mobile*</label>
                    <input type="number" class="form-control" id="mobile" placeholder="Enter your mobile no" value="<?php echo set_value('mobile'); ?>" name="mobile" autocomplete="off" >
                    <em id="password-em"></em>
                    <?php echo form_error('mobile', '<div class="error">', '</div>'); ?>
                </div>
                <button type="submit" class="btn btn-primary btn-block login-button" id="submit-btn">Check</button>
            </form>
        </div>
    </div>
