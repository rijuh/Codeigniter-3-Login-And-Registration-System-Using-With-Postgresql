        ...
        <div class="login-container">
            ...
            <form method="post" action="<?php echo base_url('reset-password'); ?>">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" placeholder="Enter your email id" value="<?php echo $email; ?>" name="email" autocomplete="off" readonly >
                    <em id="email-em"></em>
                    <?php echo form_error('email', '<div class="error">', '</div>'); ?>
                </div>
                <div class="form-group">
                    <label for="mobile">Mobile*</label>
                    <input type="number" class="form-control" id="mobile" placeholder="Enter your mobile no" value="<?php echo $mobile; ?>" name="mobile" autocomplete="off" readonly >
